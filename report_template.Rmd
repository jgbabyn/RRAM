...
reslength = plotly_resids(surveyR,length,resids,'Survey Std. Residuals by Length','Length','Pearson Residual') 
reslength
```

```{r echo = FALSE,message=FALSE,warning=FALSE,out.width="100%"}
resyear = plotly_resids(surveyR,survey.year,resids,'Survey Std. Residuals by Year','Year','Pearson Residual')
resyear
```
