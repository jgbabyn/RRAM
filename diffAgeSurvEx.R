...
d_and_p = build_data_and_parameters(weight_array,maturity_array,survey,
                          landings,0.05,catch_stuff$prop_catch,catch_stuff$agg_key,
                          years=1983:2020,ages=1:20,survey_l_key=survey_l_key,
                          tmb.map=tmap,survey_sd_map = neomap,catch_prop_map = NULL,rounding_bit = 0.05,gf_ext=TRUE,sel_type = "old",l_dist="normal",s_dist="normal",c_dist="normal",plus_surv_sd=TRUE)
...
##create the report!
create_report("diffAgeSurvReport",outdat,"./",tmb.data,modDat)
